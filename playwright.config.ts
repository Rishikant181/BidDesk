...
export default defineConfig({
 ...
 webServer:{command:production?"npm start -- --port 3001":"npm run dev -- --port 3001",url:"http://localhost:3001/sign-in",reuseExistingServer:false,timeout:120000,env:{BIDDESK_AI_TEST_STUB:"1",MONGODB_DB:process.env.BIDDESK_TEST_DB,BETTER_AUTH_URL:"http://localhost:3001",BIDDESK_DIST_DIR:production?".next":".next-test"}},
});
